      ...
      coffee_mug.onclick = function(){
        if (this.style.opacity!=0){
          ...
          let audio = new Audio("audio/drinking.mp3");
          audio.play();
        }
      }
      function getCoffee(coffeeName,cost){
        if (money.value >= cost){
          ...
          let audio = new Audio("audio/zakipanie-coffee.mp3");
          audio.play();
        }
        else
      ...
      function getChange(num){
        ...
        let coin;
        let top = getRandom(0, change_box.offsetHeight-62);
        let left = getRandom(0, change_box.offsetWidth-62);
        if (num>=10) coin = 10;
        ...
        num-=coin;
        let audio = new Audio("audio/zvuk-zvona-monet.mp3");
        audio.play();
        } 
      } 
